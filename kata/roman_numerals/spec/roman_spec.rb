...
describe 'Roman numerals converter' do
	...
	it "converts one numeral with correct order swap where appropriate" do
	...
	it "converts the integer number to roman numeral" do
	...
	it "converts the roman numeral to integer" do
